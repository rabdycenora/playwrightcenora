...
test('test', async ({ page }) => {
  await page.goto('https://oceania.testing.links-agent.cenora.io/');
  await page.goto('https://oceania.testing.links-agent.cenora.io/login');
  await page.getByRole('textbox', { name: 'Email' }).fill('rabdy+ocenia@cenora.com');
